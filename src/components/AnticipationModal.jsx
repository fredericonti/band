...
const AnticipationModal = ({ isOpen, onClose, showData }) => {
    ...
    return (
        <SideSheet
            isOpen={isOpen}
            onClose={onClose}
            title="ANTECIPAÇÃO DE CACHÊ"
        >
            <div className="anticipation-workflow">
                {step === 1 && (
                ...
                {step === 2 && (
                    <div className="modal-step">
                        <div className="terms-header">
                            ...
                            <h3 className="section-title">TERMOS DE COMPROMISSO</h3>
                        </div>
                ...
                {step === 3 && (
                    <div className="modal-step text-center">
                        ...
                        <h2 className="modal-title" style={{ fontSize: '1.5rem' }}>SOLICITAÇÃO REALIZADA!</h2>
